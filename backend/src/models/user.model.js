...
var createUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, pool.query('INSERT INTO users (username, email, password) VALUES ($1, $2, $3) RETURNING *', [username, email, password] // Save the plain-text password directly
                )];
            case 1:
                result = _c.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, pool.query(query, [email])];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result.rows[0]];
        }
