...
var fetchTracks = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (limit) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("".concat(API_BASE, "/tracks/?client_id=").concat(CLIENT_ID, "&format=json&limit=").concat(limit, "&include=musicinfo&audioformat=mp32"))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                ...
                case 2:
                    data = _a.sent();
                    return [2 /*return*/, data.results.map(function (track) { return ({
                            id: track.id,
                            name: track.name,
